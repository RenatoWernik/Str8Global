...
export const metadata: Metadata = {
  title: 'Espaço — Str8Global',
  description: 'Conheça o nosso espaço criativo em Lisboa. Estúdios, co-working e áreas comuns.',
  openGraph: {
    title: 'Espaço — Str8Global',
    description: 'Conheça o nosso espaço criativo em Lisboa.',
