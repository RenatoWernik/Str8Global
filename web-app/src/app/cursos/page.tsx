...
export const metadata: Metadata = {
  title: 'Cursos — Str8Global',
  description: 'Cursos de marketing, fotografia e conteúdo digital. Formação premium pela Str8Global.',
  openGraph: {
    title: 'Cursos — Str8Global',
    description: 'Cursos de marketing, fotografia e conteúdo digital.',
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-black px-6">
      ...
      <div className="relative z-10 text-center max-w-lg">
        <h1 className="text-5xl md:text-7xl font-bold mb-4">Cursos</h1>
