...
export default function ServicosPage() {
  return (
    <main className="relative min-h-screen bg-black">
      ...
      <CTASection
        badge={ctaCopy.servicos.badge}
        headline={ctaCopy.servicos.headline}
        subtitle={ctaCopy.servicos.subtitle}
        buttonText={ctaCopy.servicos.buttonText}
        buttonHref={ctaCopy.servicos.buttonHref}
      />
    </main>
  );
}
